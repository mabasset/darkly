...
_NOTE:_ The README gives a hint that the flag is written somewhere in a README file
...
This script recursively reads the content of each README in each subdirectory starting from .hidden/
